# -*- coding: utf-8 -*-
"""
Created on Sat Jun 11 03:24:18 2022
    ...
    def parse_imp(info):
        ...
        for event in info['events']:
            ...
            if event['description'] == 'Impedance':
                ...
                imp = {'time': imp_time, 'unit': imp_unit, 'measurement': dict(zip(labels, imp_vals))}
    ...
    def parse_video(info):
        ...
        for event in events:
            ...
            if event['description'].startswith('Video'):
                ...
                video = {'onset': video_time, 'length': video_len, 'description': video_desc, 'filename': video_file}
...
def read_evt(filename):
    ...
    def read_library(fid):
        ...
        # Sets the ouput.
        library = {'name': name, 'entries': events}
    ...
    def read_artefact(fid):
        raise NotImplementedError('Not yet coded.')

    def read_spike(fid):
        raise NotImplementedError('Not yet coded.')

    def read_seizure(fid):
        raise NotImplementedError('Not yet coded.')
    ...
    def read_epoch_descriptors(fid):
        ...
        for dindex in range(ndesc):
            ...
            # Stores the output.
            desc = {'name': dname, 'data': ddata, 'unit': dunit}
    ...
    def read_chaninfo(fid):
        ...
        # Prepares the output.
        chaninfo = {'active': active, 'ref': ref}
